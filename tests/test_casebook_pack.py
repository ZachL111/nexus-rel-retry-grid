"""Regression checks for the nexus-rel-retry-grid casebook."""
...
from casebook.harness import assert_expected, nexus_rel_retry_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_rel_retry_grid_summary(), assert_expected())
